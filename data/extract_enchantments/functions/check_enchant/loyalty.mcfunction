#> extract_enchantments:check_enchant/loyalty
#
...
#エンチャ本が対象だった場合
execute if data storage rukky-func get_inventory.data.tag.StoredEnchantments[{id:"minecraft:loyalty"}] run function extract_enchantments:modify/eb_loyalty
#それ以外が対象だった場合
execute if data storage rukky-func get_inventory.data.tag.Enchantments[{id:"minecraft:loyalty"}] run function extract_enchantments:modify/not_eb_loyalty
