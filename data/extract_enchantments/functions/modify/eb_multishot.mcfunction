#> extract_enchantments:modify/eb_multishot
#
...
# エンチャントの内容をコピー
execute at @s run data modify entity @e[tag=EE_item,sort=nearest,limit=1] Item.tag.StoredEnchantments[0] set from storage rukky-func get_inventory.data.tag.StoredEnchantments[{id:"minecraft:multishot"}]
...
# 編集用ストレージからエンチャントを削除
data remove storage rukky-func modify_inventory.data.tag.StoredEnchantments[{id:"minecraft:multishot"}]
